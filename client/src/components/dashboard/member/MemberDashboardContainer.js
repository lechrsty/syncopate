...
export const MemberDashboardContainer = () => {
    ...
    const IMAGES_RIGHT = [
        ...
        'https://res.cloudinary.com/dmilofp0z/image/upload/v1681784666/pexels-photo-6862369_hzvbmh.jpg',
        ...
        'https://res.cloudinary.com/dmilofp0z/image/upload/v1681784322/pexels-koolshooters-6621701_ixzdfp.jpg',
